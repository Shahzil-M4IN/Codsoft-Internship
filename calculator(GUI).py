...
def calc(n1_entry_var, n2_entry_var, operator_val, result_label):
    try:
        n1_entry_var.set(n1_entry.get())
        n2_entry_var.set(n2_entry.get())
        n1 = n1_entry_var.get()  
        n2 = n2_entry_var.get()  
        op = operator_val.get()  
        if op=='+':
...
calculate=tk.Button(main,text='Calculate',font=('Xenara',15),bg='light grey',command=lambda: calc(n1_entry_var,n2_entry_var,operator_val,result_label))
